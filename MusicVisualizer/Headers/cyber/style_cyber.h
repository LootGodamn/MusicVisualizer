...
static const Rectangle_ cyberFontRecs[189] = {
    { 4, 4, 4 , 14 },
    { 16, 4, 1 , 8 },
    { 25, 4, 4 , 3 },
    { 37, 4, 8 , 8 },
...
static void GuiLoadStyleCyber(void)
{
    ...
    font.recs = (Rectangle_ *)RAYGUI_MALLOC(font.glyphCount*sizeof(Rectangle_));
    memcpy(font.recs, cyberFontRecs, font.glyphCount*sizeof(Rectangle_));
    ...
    Rectangle_ fontWhiteRec = { 510, 254, 1, 1 };
